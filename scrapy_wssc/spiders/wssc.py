...
#
# class WsscSpider(scrapy.Spider):
#     name = 'scrapy_wssc'
#
#     def __init__(self, bid=None):
#         """初始化起始页面和游戏bid
#         """
#         super(WsscSpider, self).__init__()
#         self.bid = bid  # 参数bid由此传入
#         self.start_urls = ['https://tieba.baidu.com/f?kw=%E8%BF%90%E7%9A%84%E6%98%93&ie=utf-8&tp=0']
#         self.allowed_domain = 'tieba.baidu.com'
